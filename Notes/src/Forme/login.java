...
public class login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try
       {
           String Sql="SELECT * FROM login WHERE user_name='"+txt_utilisateur.getText()+"' and pass='"+txt_passe.getPassword()+"'";
           Ps=Cnx.prepareStatement(Sql);
           Rs=Ps.executeQuery();
           
           if(Rs.next()){JOptionPane.showMessageDialog(null,"Connect");
                        menu me= new menu();
                             me.setVisible(true);
                           //this.dispose()
                             }
